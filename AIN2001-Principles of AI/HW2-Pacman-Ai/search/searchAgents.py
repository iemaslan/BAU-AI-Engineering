...
class SearchAgent(Agent):
    ...
    def _init_(self, fn='depthFirstSearch', prob='PositionSearchProblem', heuristic='nullHeuristic'):
        ...
        if 'heuristic' not in func._code_.co_varnames:
...
class PositionSearchProblem(search.SearchProblem):
    ...
    def _init_(self, gameState, costFn = lambda x: 1, goal=(1,1), start=None, warn=True, visualize=True):
        """
    ...
    def isGoalState(self, state):
        ...
        if isGoal and self.visualize:
            ...
            import _main_
            if 'display' in dir(main_):
                if 'drawExpandedCells' in dir(_main_._display): #@UndefinedVariable
                    _main_._display.drawExpandedCells(self._visitedlist) #@UndefinedVariable
...
class CornersProblem(search.SearchProblem):
    ...
    def _init_(self, startingGameState: pacman.GameState):
        """
